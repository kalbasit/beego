...
type Post struct {
	...
	Updated time.Time `orm:"auto_now"`
	Tags    []*Tag    `orm:"rel(m2m);rel_through(github.com/eMxyzptlk/beego/orm.PostTags)"`
}
...
go get -u github.com/eMxyzptlk/beego/orm
...
go test -v github.com/eMxyzptlk/beego/orm
